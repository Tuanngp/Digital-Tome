 ...
 var dzChartlist = function(){
	...
	var AllProject = function(){
       ...
       plotOptions: {
		 ...
		 colors: ['#3AC977', 'var(--primary-light)', 'var(--secondary-light)'],
	...
	var Traffic = function(){
       ...
       plotOptions: {
		 ...
		 colors: ['#3AC977','#666cff', 'var(--primary-light)', 'var(--secondary-light)','#000'],
	...
	var ExtraData = function(){
		var options = {
			...
			colors:['#DCDFE5', 'var(--primary-light)', '#FFCCC0'],
			xaxis: {
				show: false,
				axisBorder: {
					show: false,
