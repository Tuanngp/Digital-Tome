...
////    public String resendOtp(RedirectAttributes redirectAttributes) {
////        UserDto userDto = (UserDto) httpSession.getAttribute("tempUserDto");
////
////        if (userDto == null) {
////            redirectAttributes.addFlashAttribute("errorMessage", "User information not found. Please restart the registration process.");
////            return "redirect:/register";
////        }
////
////        String newOtp = generateToken();
////        httpSession.setAttribute("otp", newOtp); // Updating the session with the new OTP
////
////        try {
////            emailService.sendHtmlEmail(userDto.getEmail(), newOtp);
...
////        }
////
////        return "redirect:/otp"; // Redirect back to the OTP verification page
////    }
