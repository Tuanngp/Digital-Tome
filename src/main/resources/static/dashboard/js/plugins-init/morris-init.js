	...
	var dlabMorris = function(){
		...
		var lineChart = function(){
			...
			let line = new Morris.Line({
				...
				lineColors: ['rgb(207, 248, 89)'], //here
				lineWidth: 1,
				hideHover: 'auto',
				pointSize: 0,
				axes: false
		...
		var lineChart2 = function(){
			...
			Morris.Area({
				...
				pointSize: 3,
				fillOpacity: 0,
				pointStrokeColors: ['#EE3C3C', '#000', '#cff859'],
				behaveLikeLine: true,
				gridLineColor: 'transparent',
				lineWidth: 3,
				hideHover: 'auto',
				lineColors: ['rgb(207, 248, 89)', 'rgb(0, 171, 197)', '#cff859'],
				resize: true
		...
		var areaChart = function(){
			...
			Morris.Area({
				...
				lineColors: ['#cff859', 'rgb(16, 202, 147)', 'rgb(255, 92, 0)'],
				xkey: 'period',
				ykeys: ['smartphone', 'windows', 'mac'],
				labels: ['Phone', 'Windows', 'Mac'],
				pointSize: 0,
