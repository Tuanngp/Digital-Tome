					...
					datasets: [
						{
							...
							borderColor: 'rgba(207, 248, 89, 1)',
							borderWidth: "0",
							backgroundColor: 'rgba(207, 248, 89, 1)'
	...
	var chartWidget9 = function(){
		...
		new Chart(chart_widget_9, {
			...
			data: {
				...
				datasets: [{
					label: "Sales Stats",
					backgroundColor: "#CFF859",
					borderColor: '#CFF859',
					pointBackgroundColor: '#CFF859',
					pointBorderColor: '#CFF859',
					pointHoverBackgroundColor: '#CFF859',
					pointHoverBorderColor: '#CFF859',
		...
		new Chart(chart_widget_10, {
			...
			data: {
				...
				datasets: [{
					...
					borderColor: '#d7e3ff',
					pointBackgroundColor: '#d7e3ff',
					pointBorderColor: '#d7e3ff',
					pointHoverBackgroundColor: '#d7e3ff',
					pointHoverBorderColor: '#d7e3ff',
					borderWidth: 0, 
	...
	var chartWidget11 = function(){
		...
		new Chart(chart_widget_11, {
			...
			data: {
				...
				datasets: [{
					label: "Sales Stats",
					backgroundColor: "rgba(247,248,89,0.5)",
					borderColor: '#A0CF1A',
					pointBackgroundColor: '#A0CF1A',
					pointBorderColor: '#A0CF1A',
					pointHoverBackgroundColor: '#A0CF1A',
