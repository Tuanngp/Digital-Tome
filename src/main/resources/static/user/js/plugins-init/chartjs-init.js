 ...
 var dlabSparkLine = function(){
					...
					datasets: [
						{
							...
							borderWidth: "0",
							colors: '#eee',
							backgroundColor: 'rgba(160, 207, 26, 1)'
						}
					]
				},
				options: {
	...
	var barChart2 = function(){
		...
		//gradient bar chart
			...
			barChart_2gradientStroke.addColorStop(0, "rgba(255, 124, 124, 1)");
			barChart_2gradientStroke.addColorStop(1, "rgba(255, 124, 124, 0.5)");
					...
					datasets: [
						{
							...
							borderColor: 'rgba(160, 207, 26, 1)',
							borderWidth: "2",
							backgroundColor: 'transparent',  
							pointBackgroundColor: 'rgba(160, 207, 26, 1)'
						}
					]
				},
				options: {
	...
	var lineChart2 = function(){
		...
		if(jQuery('#lineChart_2').length > 0 ){
			...
			lineChart_2gradientStroke.addColorStop(0, "rgba(160, 207, 26, 1)");
			lineChart_2gradientStroke.addColorStop(1, "rgba(160, 207, 26, 0.5)");
