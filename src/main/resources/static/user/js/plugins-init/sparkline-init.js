	...
	var sparkLine8 = function(){
		if(jQuery('#sparkline8').length > 0 ){	
			$("#sparkline8").sparkline([79, 72, 29, 6, 52, 32, 73, 40, 14, 75, 77, 39, 9, 15, 10], {
				...
				height: "50",
				lineColor: "#cff859",
				fillColor: "rgba(207, 248, 89,1)",
				minSpotColor: "#cff859",
				maxSpotColor: "#cff859",
				highlightLineColor: "#cff859",
				highlightSpotColor: "#cff859",
		...
		if(jQuery('#StackedBarChart').length > 0 ){	
			$('#StackedBarChart').sparkline([
				...
				[4, 1, 2]
					...
					barWidth: 10,
					barSpacing: 7, 
					stackedBarColor: ['#cff859', '#000', '#ff5c00']
				});
		}
	}
	...
	var sparkLine12 = function(){
		if(jQuery('#sparkline12').length > 0 ){
			...
			$("#sparkline12").sparkline([24, 61, 51], {
				...
				height: "100",
				resize: !0,
				sliceColors: ["rgba(0, 0, 0, 1)", "rgba(135, 137, 129, 1)", "rgba(135, 137, 129, 1)"]
			});
		}	
	}	
